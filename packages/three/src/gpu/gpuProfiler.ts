...
function timestampQueryCount(renderer: TimestampCapableRenderer, type: 'render' | 'compute') {
...
function computeDispatchSize(dispatchSize: unknown): GpuComputePassTiming['dispatchSize'] {
