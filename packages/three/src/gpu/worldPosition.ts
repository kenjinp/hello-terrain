...
import type { LeafStorageState, TerrainUniformsContext, VisibleSlotStorageState } from '../types';
...
function renderFieldSlot(visibleSlotStorage?: VisibleSlotStorageState): Node {
    ...
    return visibleSlotStorage ? visibleSlotStorage.node.element(drawIndex).toInt() : drawIndex;
}
