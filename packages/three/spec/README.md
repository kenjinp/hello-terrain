...
- [`validation-gym.md`](./validation-gym.md): scenario-driven correctness harness — behavioral invariants, kinematic probe, analytic ground truth, visual `/gym` page, CDP runner, and CI strategy.
