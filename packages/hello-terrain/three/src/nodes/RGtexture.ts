import { Fn, float, int, texture, vec2 } from "three/tsl";
...
export const readGreyStyle = Fn(([rgTexture, uv]: [rgTexture: Texture, uv: Node]) => {
...
export const floatToRG = Fn(([value]: [value: Node]) => {
