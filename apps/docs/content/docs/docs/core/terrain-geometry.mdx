...
<ExampleLayout title="Terrain Geometry" description="The base terrain tile geometry which makes up the hello terrain system">
  <Scene />
</ExampleLayout>

## Overview

This is the basic geometry unit of the Hello Terrain system. It will be instanced and duplicated to render the terrain scene.
...
This way, if we pull down the edges to make a box-like terrain skirt, the corners will not be distorted on opposing sides of the tile. 
