...
<div className="not-prose my-6 space-y-6">
  ...
  <div className="grid grid-cols-2 gap-3">
    <img src="/assets/steps-1.png" alt="Terracing visible in slope shadows — view 1" className="rounded w-full" />
    <img src="/assets/no-steps-1.png" alt="Smooth slopes without terracing — view 1" className="rounded w-full" />
  </div>
  <div className="grid grid-cols-2 gap-3">
    <img src="/assets/steps-2.png" alt="Terracing visible in slope shadows — view 2" className="rounded w-full" />
    <img src="/assets/no-steps-2.png" alt="Smooth slopes without terracing — view 2" className="rounded w-full" />
  </div>
</div>
