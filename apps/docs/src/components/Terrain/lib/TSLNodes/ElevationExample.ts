...
export const exampleElevationFunction = ElevationFn(({ worldUv, heightmapScale }) => {
...
export const complexElevationFunction = ElevationFn(({ worldUv, heightmapScale, level }) => {
  // Base FBM noise
